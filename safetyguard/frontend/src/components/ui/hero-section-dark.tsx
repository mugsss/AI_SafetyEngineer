        ...
        <section className="relative z-[1] mx-auto max-w-full">
          ...
          <div className="mx-auto max-w-screen-xl gap-12 px-4 py-28 md:px-8">
            <div className="mx-auto max-w-3xl space-y-5 text-center leading-0 lg:leading-5">
              ...
              <h2 className="font-sans mx-auto bg-[linear-gradient(180deg,_#000_0%,_rgba(0,_0,_0,_0.75)_100%)] bg-clip-text text-4xl tracking-tighter text-transparent dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)] md:text-6xl">
                {subtitle.regular}
              ...
              <div className="items-center justify-center space-y-3 sm:flex sm:space-y-0 sm:gap-x-3">
